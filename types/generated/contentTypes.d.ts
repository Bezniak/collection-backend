...
export interface ApiCollectionCollection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.Relation<
      ...
      'api::item.item'
    >;
    user_name: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    user_id: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    additionalFields: Attribute.JSON &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLikeLike extends Schema.CollectionType {
  ...
  attributes: {
    item: Attribute.Relation<'api::like.like', 'oneToOne', 'api::item.item'>;
    user: Attribute.Relation<
      'api::like.like',
      'manyToOne',
      'plugin::users-permissions.user'
...
export interface ApiTicketTicket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<
      ['Open', 'In Progress', 'Rejected', 'Resolved']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
